  ...
  return (
    ...
    >
      <div className="grid gap-3 sm:grid-cols-2">
        <div>
          <label className="block text-sm font-medium mb-1">Transporter ID (GSTIN/TRANSIN)</label>
        ...
        <div>
          <label className="block text-sm font-medium mb-1">LR / Transport doc no</label>
          <input type="text" value={form.transDocNo} onChange={set('transDocNo')} className="ui-input w-full px-3 py-2" placeholder="LR-1234" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1">Transport doc date</label>
