        ...
        >
          ...
          <div className="relative z-10 p-12 flex flex-col w-full text-white">
            ...
            <p className="mt-8 text-white/40 text-xs">
              © 2026 Clor · Your data stays on your server
            </p>
          </div>
        </div>
                ...
                */}
                ...
                {error && (
                  <div className="bg-[rgb(var(--neg-soft))] border border-[rgb(var(--neg))]/30 rounded-xl p-4 flex items-start gap-3 max-h-28 overflow-auto">
                    <svg className="w-5 h-5 text-[rgb(var(--neg))] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <p className="text-sm text-[rgb(var(--neg))] break-words">{String(error)}</p>
                  </div>
                )}
