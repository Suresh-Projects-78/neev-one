 ...
 */
export const StatTile = ({ label, value, hint, tone = 'neutral', icon: Icon = null }) => {
  ...
  return (
    <div className="ui-card p-4">
      ...
      <div className={`mt-2 text-2xl font-semibold tracking-tight ${toneClass || 'ui-title'}`}>{value}</div>
        ...
        {Array.from({ length: cols }).map((__, c) => (
          <td key={c} className="px-3 py-2">
            <div
              ...
              style={{ backgroundColor: 'rgb(var(--surface-sunken))', width: c === 0 ? '60%' : '80%' }}
            />
          </td>
        ))}
      </tr>
