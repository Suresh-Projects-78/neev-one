...
export const SETTINGS_CATEGORIES = [
  ...
  },
  {
    ...
    title: 'Payroll',
    icon: Wallet,
    description: 'Salary components, pay groups, periods and the statutory rules.',
  },
  {
    id: 'security',
...
export const SETTINGS_ITEMS = [
  ...
  { key: 'settingsBilling', title: 'Billing', category: 'finance', icon: Receipt, perm: 'SETTINGS::Company Profile::VIEW', group: 'Your account', description: 'What you are charged for Clor, and the invoices for it.', keywords: ['payment method', 'invoice', 'card', 'subscription'] },
  ...
  { key: 'payrollLedgerMapping', title: 'Ledger Mapping', category: 'payroll', icon: Landmark, perm: 'PAYROLL::Payroll Settings::VIEW', feature: 'payroll', group: 'Accounting', description: 'Which account each part of a salary posts to. Payroll cannot reach the books without it.', keywords: ['ledger', 'account', 'posting', 'mapping', 'chart of accounts', 'expense', 'liability'] },
